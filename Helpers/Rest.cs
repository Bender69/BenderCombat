...
namespace BenderCombat.Helpers
{
	public static class Rest
	{
		...
		public static bool NeedRest()
		{
			...
			return !BenderCombat.MovementDisabled && !Me.InCombat && (resource < 50 || Me.HealthPercent < 90
		...
		{
			var resource = NormalizedResource();
			return !BenderCombat.MovementDisabled && !Me.InCombat && (resource < 100 || Me.HealthPercent < 100
