		...
		public override Composite Buffs
		{
			get
			{
				return new PrioritySelector(
					...
					Spell.Buff("Stealth", ret => !Rest.KeepResting() && !BenderCombat.MovementDisabled && !Me.IsMounted)
					);
			}
		}
		...
		public override Composite SingleTarget
		{
			get
			{
				return new PrioritySelector(
					...
					//Interrupts
					Spell.Cast("Jolt", ret => Me.CurrentTarget.IsCasting && !BenderCombat.MovementDisabled),
					Spell.Cast("Electrocute", ret => Me.CurrentTarget.IsCasting && !BenderCombat.MovementDisabled),
					Spell.Cast("Low Slash", ret => Me.CurrentTarget.IsCasting && !BenderCombat.MovementDisabled),
