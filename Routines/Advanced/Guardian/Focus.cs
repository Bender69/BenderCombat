			...
			get
			{
				return new PrioritySelector(
					Spell.Cast("Saber Throw",
						ret => !BenderCombat.MovementDisabled && Me.CurrentTarget.Distance >= 0.5f && Me.CurrentTarget.Distance <= 3f),
					...
					Spell.Cast("Awe", ret => Me.CurrentTarget.IsCasting && !BenderCombat.MovementDisabled),
					Spell.Cast("Force Stasis", ret => Me.CurrentTarget.IsCasting && !BenderCombat.MovementDisabled),
