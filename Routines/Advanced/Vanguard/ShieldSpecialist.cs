...
namespace BenderCombat.Routines
{
	public class ShieldSpecialist : RotationBase
	{
		...
		public override Composite SingleTarget
		{
			...
			{
				return new PrioritySelector(
					//Spell.Cast("Harpoon", ret => Me.CurrentTarget.Distance >= 1f),
					...
					new Decorator(ret => Me.ResourcePercent() < 60,
						new PrioritySelector(
							...
							Spell.Cast("Ion Storm", ret => Me.HasBuff("Pulse Engine") && Me.CurrentTarget.Distance <= 1f),
					...
					Spell.Cast("Riot Strike",
						ret =>
							Me.CurrentTarget.IsCasting && Me.CurrentTarget.Distance <= Distance.Melee && !BenderCombat.MovementDisabled),
			...
			get
			{
				return new Decorator(ret => Targeting.ShouldAoe,
					new PrioritySelector(
						...
						Spell.Cast("Explosive Surge", ret => Me.CurrentTarget.Distance <= 0.5f)
						));
			}
		}
	}
