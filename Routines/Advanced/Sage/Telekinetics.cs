		...
		public override Composite SingleTarget
		{
			get
			{
				return new PrioritySelector(
					...
					Spell.Cast("Mental Alacrity"), //, ret => Me.CurrentTarget.StrongOrGreater()),
					Spell.Cast("Turbulence", ret => Me.CurrentTarget.HasDebuff("Weaken Mind") && !Me.HasBuff("Force Potency")),
					Spell.Cast("Force Potency"), //, ret => Me.CurrentTarget.StrongOrGreater()),
